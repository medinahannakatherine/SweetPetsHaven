...
<body>
  ...
  <div class="center">
    <h1 class="align-items-center"><b>Pets for Adoption</b></h1>
        ...
        <div class="dog-slider">
          ...
          if ($fetch_data > 0) {
            ...
            foreach ($fetch_data as $key => $row) {
              ...
              echo '<a href="adopt-form.php?imageSrc=' . urlencode($row['url']) . "&petID=" . $row['pet_id'] . '&cat=false">';
        ...
        <div class="cat-slider">
          ...
          if ($fetch_data > 0) {
            foreach ($fetch_data as $key => $row) {
              ...
              echo '<div class="slider-hover">';
              echo '<a href="adopt-form.php?imageSrc=' . urlencode($row['url']) . "&petID=" . $row['pet_id'] . '&cat=true">';
